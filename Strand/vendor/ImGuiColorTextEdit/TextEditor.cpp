...
// Replace ImGui::PushAllowKeyboardFocus(true); with ImGui::PushItemFlag(ImGuiItemFlags_AllowKeyboardFocus, true);
// Replace ImGui::PopAllowKeyboardFocus(); with ImGui::PopItemFlag();
