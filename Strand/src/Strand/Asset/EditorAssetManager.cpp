...
namespace Strand {
	...
	static AssetType GetAssetTypeFromFileExtension(const std::filesystem::path& extension)
	{
		...
		{
			//TODO AGAIN SPGLOG
			SD_CORE_WARN("Could not find AssetType for {}", extension.string());
	...
	Ref<Asset> EditorAssetManager::GetAsset(AssetHandle handle)
	{
		...
		else
		{
			...
			{
				// import failed
				SD_CORE_ERROR("EditorAssetManager::GetAsset - asset import failed!");
			}
			m_LoadedAssets[handle] = asset;
		}
		// 3. return asset
	...
	bool EditorAssetManager::DeserializeAssetRegistry()
	{
		...
		{
			//TODO ADD MORE SPD LOG Specializition
