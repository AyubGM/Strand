...
namespace Strand {
	...
	Strand::Ref<Strand::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Strand::Ref<Strand::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Strand::Ref<Strand::Shader> ShaderLibrary::Get(const std::string& name)
	{
