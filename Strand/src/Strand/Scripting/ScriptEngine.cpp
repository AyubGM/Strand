...
namespace Strand {
	...
	static std::unordered_map<std::string, ScriptFieldType> s_ScriptFieldTypeMap =
	{
		...
		{ "Strand.Vector2", ScriptFieldType::Vector2 },
		{ "Strand.Vector3", ScriptFieldType::Vector3 },
		{ "Strand.Vector4", ScriptFieldType::Vector4 },

		{ "Strand.Entity", ScriptFieldType::Entity },
	};
	...
	void ScriptEngine::LoadAssemblyClasses()
	{
		...
		int32_t numTypes = mono_table_info_get_rows(typeDefinitionsTable);
		MonoClass* entityClass = mono_class_from_name(s_ScriptData->CoreAssemblyImage, "Strand", "Entity");
