	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	Strand::Ref<Strand::VertexBuffer> vertexBuffer = Strand::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Strand::Ref<Strand::IndexBuffer> indexBuffer = Strand::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	...
	Strand::Ref<Strand::VertexBuffer> squareVB = Strand::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ Strand::ShaderDataType::Float3, "a_Position" },
	...
	Strand::Ref<Strand::IndexBuffer> squareIB = Strand::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
...
void ExampleLayer::OnUpdate(Strand::Timestep ts)
{
	// Update
...
void ExampleLayer::OnEvent(Strand::Event& e)
{
