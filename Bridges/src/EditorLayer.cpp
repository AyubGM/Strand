...
namespace Strand {
	...
	void EditorLayer::OnAttach()
	{
		...
		Strand::FramebufferSpecification fbSpec;
		fbSpec.Width = 1280;
		fbSpec.Height = 720;
		m_Framebuffer = Strand::Framebuffer::Create(fbSpec);
	}
	...
	void EditorLayer::OnUpdate(Strand::Timestep ts)
	{
		SD_PROFILE_FUNCTION();


		// Resize
		if (Strand::FramebufferSpecification spec = m_Framebuffer->GetSpecification();
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		if (ImGui::BeginMenuBar())
		{
			if (ImGui::BeginMenu("File"))
			{
				...
				if (ImGui::MenuItem("Exit")) Strand::Application::Get().Close();
				ImGui::EndMenu();
			}
	...
	void EditorLayer::OnEvent(Strand::Event& e)
	{
